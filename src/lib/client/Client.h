...
public:
    ...
    */
    ...
    //! Received server audio chunk
    void                audioChunkReceived(UInt8 mark, const std::string& data);

    //! Received copied file information
    void                fileClipboardReceived(UInt32 fileNum, std::string data);
...
private:
    ...
    void                sendClipboardFiles(const IClipboard* clipboard);
    void                sendFilesToServer(const FilePathList& filenames);
