...
void
PrimaryClient::audioChunkSending(UInt8 mark, const char* data, size_t dataSize)
{
    // ignore
}

void
PrimaryClient::sendFileClipboard(UInt32 fileCount, const char* info, size_t size)
{
    // ignore
}
